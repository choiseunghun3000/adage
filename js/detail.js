...
var $divede_aff = $hash_txt.split("_");
console.log($divede_aff); //['nike', '1']
console.log($divede_aff[0]); //카테고리 정의(nike | adidas | puma)
console.log($divede_aff[1]); //각 카테고리별 데이터의 인덱스 번호(0|1|2|3)
var $brand = $divede_aff[0]; //카테고리 정의(nike | adidas | puma)
var $index = $divede_aff[1]; //각 카테고리별 데이터의 인덱스 번호(0|1|2|3)

//선택자 구성
var $detailBg = document.querySelector("#cont .wrap .ad_img1");
